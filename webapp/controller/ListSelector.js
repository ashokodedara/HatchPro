sap.ui.define([
		...
		return BaseObject.extend("webapp.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias webapp.model.ListSelector
			 */
			 ...
			 * @return {webapp.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
